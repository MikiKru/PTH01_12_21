...
print(len(men_in_warsaw), men_in_warsaw)
...
print(len(people_with_age), people_with_age)
...
def get_data():         # funkcja pobierająca dene z bazy danych
    pass
def get_data_by_gender_and_address(gender=True, address='Warszawa'):
    pass
def get_data_by_age(low_tresh, high_tresh):
    pass
def get_mean_age(gender, name_starts_with='A'):
    pass