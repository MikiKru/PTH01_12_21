...
from d4.mvc.models import Point2D, Point3D
...
class Point3DController(Point2DController):
    def __init__(self):
        self.__points3d = []
...
print("[1,1][2,2] compare dist to [0,0] =",p2d.compare_0_0(Point2D(6,1), Point2D(2,2)))
p3d = Point3DController()
print("[1,1,1][2,2,2] dist =",p3d.calculate_distance(Point3D(1,1,1), Point3D(2,2,2)))
print("[1,1,1][2,2,2] compare dist to [0,0,0] =",p3d.compare_0_0(Point3D(1,1,1), Point3D(2,2,2)))
p1 = Point3D(1,2,3)
p2 = Point3D(3,2,3)
p3d.add_point(p1)
p3d.add_point(p2)
